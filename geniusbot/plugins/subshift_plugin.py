...
def initialize_subshift_tab(self):
    ...
    self.open_subtitlefile_button.clicked.connect(open_subtitlefile)
    ...
    self.shift_subtitle_button.clicked.connect(shift_subtitle)
    ...
    self.sub_time_spin_box.valueChanged.connect(check_subtitle_seconds)
