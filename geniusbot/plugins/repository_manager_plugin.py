...
def initialize_repository_manager_tab(self):
    ...
    self.repository_manager_repositories_file_location_button.clicked.connect(open_repository_manager_file)
    ...
    self.repository_manager_run_button.clicked.connect(manage_repositories)
