...
def initialize_media_downloader_tab(self):
    ...
    self.channel_field_label.clicked.connect(add_channel_videos)
    ...
    self.video_download_button.clicked.connect(download_videos)
    ...
    self.open_video_file_button.clicked.connect(open_video_file)
    ...
    self.video_save_location_button.clicked.connect(media_download_save_location)
